      ...
      <div className="w-full mx-auto border-t border-light-200 pt-2 text-center text-light-200">
        ...
        {links?.map((link) => (
          <Link
            key={link.url}
            href={link.url || "/"}
            className="mr-1 inline-block after:content-['|'] after:pl-1 last-of-type:after:content-none focus-brand"
          >
              ...
              (social) =>
                social.link?.url && (
                  <Link
                    ...
                    className="mr-1 inline-block focus-brand hover:text-brand-300"
