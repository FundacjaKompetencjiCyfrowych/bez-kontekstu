...
const sectionContainer = cva("flex flex-col gap-[3rem] relative", {
  variants: {
    variant: {
      regular: "",
      ...
      heroMain:
        "items-center justify-center h-[calc(92vh-18rem)] md:h-[calc(92vh-20rem)] xl:h-[calc(92vh-10rem)] min-h-[20rem] md:min-h-[30rem] xl:min-h-[40rem] pb-20",
      heroCollapsedOnMobile: "items-center justify-center h-fit xl:h-[calc(92vh-10rem)] xl:min-h-[40rem]",
