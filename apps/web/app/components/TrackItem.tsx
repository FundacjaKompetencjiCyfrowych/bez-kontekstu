...
export function TrackItem({ title, isPlaying = false, onPlay }: TrackItemProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onPlay}
        className={`relative hover:cursor-pointer md:bg-neutral-600/30 xl:bg-neutral-600/0 w-10 h-10 md:w-18 md:h-18 xl:align-middle rounded-full border-2 flex items-center justify-center transition-all duration-300 ${isHovered || isPlaying ? "border-purple-400 shadow-lg shadow-purple-400/30" : "border-purple-400/40 hover:border-purple-400/60"
          }`}
      >
      ...
      <div className="flex-1 relative">
        <div
          className={`bg-black/30 flex items-center h-[40px] md:h-[60px] md:bg-neutral-600/30 xl:bg-neutral-600/0 border rounded-2xl px-4 py-2 transition-all duration-300 ${isHovered || isPlaying ? "border-purple-400 shadow-lg shadow-purple-400/30" : "border-purple-400/40 "
            }`}
        >
