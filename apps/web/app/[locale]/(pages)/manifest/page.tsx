  ...
  return (
    <div className="flex w-full min-h-screen flex-col justify-between px-2 md:px-5 xl:flex xl:flex-col">
      ...
      <main className="relative mx-auto xl:max-w-7xl">
        <div className="relative flex md:landscape:justify-center xl:mt-[90px] xl:h-[90vh] xl:items-center xl:justify-center">
          ...
          <div className="hidden xl:block absolute bottom-0 left-1/2">
            <div className="relative w-[400px] h-[500px]">
              <Image
                src={ManifestManImage}
                alt="Mężczyzna z mikrofonem"
                fill
                sizes="400px"
        ...
        {/* Our Logo */}
        <section className="pb-20 xl:pb-40 ml-20 text-right mx-5 xl:grid xl:grid-cols-2 xl:gap-8 xl:items-start xl:ml-0 xl:mx-0" aria-labelledby="our-logo-title">
        ...
        {/* Our Goal */}
        <section className="py-10 md:py-20 xl:py-40 mx-5 xl:grid xl:grid-cols-2 xl:gap-8 xl:items-center xl:ml-0 xl:mx-0" aria-labelledby="our-goal-title">
          {/* Left Column - Image */}
          <div className="xl:col-span-1 xl:justify-self-center hidden xl:block">
            <div className="relative w-full h-96 xl:h-[600px] xl:w-[500px] mt-8 xl:mt-0">
              <Image src={ManifestOurGoalImage} alt="Nasz cel - osoba w świetle" fill className="object-cover" sizes="(max-width: 1280px) 0px, 500px" />
            </div>
          </div>
        ...
        {/* Our Vision */}
        <section className="py-10 md:py-20 xl:py-40 text-right mx-5 xl:grid xl:grid-cols-2 xl:gap-8 xl:items-start xl:mx-0" aria-labelledby="our-vision-title">
          {/* Left Column - Empty for spacing */}
          <div className="xl:col-span-1">
        ...
        {/* Our Cooperation */}
        <section className="py-10 md:py-20 xl:py-40 mx-5 xl:grid xl:grid-cols-2 xl:gap-8 xl:items-start xl:mx-0" aria-labelledby="our-cooperation-title">
          {/* Left Column - Title */}
          <div className="xl:col-span-1"></div>
        ...
        {/* Artists */}
        <section className="text-center py-10 md:py-20 xl:py-40 mx-5 xl:grid xl:grid-cols-2 xl:gap-8 xl:items-start xl:mx-0 xl:text-left" aria-labelledby="artists-title">
        ...
        {/* Fusion */}
        <section className="py-10 md:py-20 xl:py-40 mx-5 xl:grid xl:grid-cols-2 xl:gap-8 xl:items-center xl:mx-0" aria-labelledby="fusion-title">
          {/* Left Column - Image */}
          <div className="xl:col-span-1 xl:flex xl:justify-center hidden">
            <div className="relative w-full h-96 xl:h-[600px] xl:w-[500px] mt-8 xl:mt-0">
              <Image src={ManifestFusionImage} alt="Fuzja - grupa artystów na scenie" fill className="object-cover" sizes="(max-width: 1280px) 0px, 500px" />
            </div>
          </div>
          {/* Right Column - Text */}
          <div className="xl:col-span-1 xl:flex xl:flex-col xl:justify-center">
